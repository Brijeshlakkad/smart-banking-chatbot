...
(16, 1, 'Brijesh Rameshbhai Lakkad', 'saving', '2411', '2018-08-06 17:33:32', '-99', '007046167268', 1),
...
(101, 'brijeshlakkad22', 'Brijesh', 'Lakkad', 'brijeshlakkad22@gmail.com', '123456bB', '7046167267', 'line 333, line 444', 'Near Ashok Vatika Society, L.H.Road', 'Surat', 'Gujarat', 'India', 'R', '395006', '2018-08-08', 'Male', '2018-08-20 16:12:13', '2018-08-20 16:12:13', 1, 1, '469819');
...
CREATE TABLE `requests` (
  ...
  `acc_id` int(10) NOT NULL,
  `card_req` varchar(5) DEFAULT NULL,
...
INSERT INTO `requests` (`r_id`, `acc_id`, `card_req`, `status_bit`, `created_time`) VALUES
(1, 4, 'card', '1', '2018-08-05 12:27:35'),
(2, 19, 'card', '1', '2018-08-20 15:49:11'),
(4, 20, 'card', '1', '2018-08-22 16:20:18'),
(5, 20, 'card', '0', '2018-10-18 21:15:40');
...
--
ALTER TABLE `cards`
  MODIFY `card_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `transactions`
  MODIFY `t_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
